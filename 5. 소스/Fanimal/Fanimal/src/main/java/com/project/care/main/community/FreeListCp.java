...
@WebServlet("/community/freelistcp.do")
public class FreeListCp extends HttpServlet {
	...
	private void doTemp(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (n == 1) {
			...
			pagebar += String.format(" <li class=\"page-item\">\r\n"
					+ "		      <a class=\"page-link\" href=\"/fanimal/community/freelistcp.do?page=%d\" aria-label=\"Previous\">\r\n"
					+ "		        <span aria-hidden=\"true\">&laquo;</span>\r\n"
					+ "		      </a>\r\n"
					+ "		    </li> "
					, n - 1
		...
		while (!(loop > blockSize || n > totalPage)) {
			...
			if (n == nowPage) {
				...
				pagebar += String.format(" <li class=\"page-item\"><a class=\"page-link\" href=\"/fanimal/community/freelistcp.do?page=%d\">%d</a></li> "
						, n
						, n);
			}
		...
		if (n > totalPage) {
			...
			pagebar += String.format(" <li class=\"page-item\">\r\n"
					+ "		      <a class=\"page-link\" href=\"/fanimal/community/freelistcp.do?page=%d\" aria-label=\"Next\">\r\n"
					+ "		        <span aria-hidden=\"true\">&raquo;</span>\r\n"
					+ "		      </a>\r\n"
					+ "		    </li> "
					, n
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/views/community/freelistcp.jsp");
