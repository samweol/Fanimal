		...
		<div class="container" style="padding-top:30px;">			
				...
				<div class="btns">
					...
					<input type="button" value="돌아가기" class="btn btn-secondary"
						onclick="location.href='/fanimal/community/freelist.do?column=${column}&word=${word}';">
				...
				<!-- 댓글 -->
				 <c:if test="${not empty auth.id }">
				<form method="POST" action="/fanimal/community/freecommentaddok.do" style="display:flex; justify-content: center; padding-bottom: 15px;">
