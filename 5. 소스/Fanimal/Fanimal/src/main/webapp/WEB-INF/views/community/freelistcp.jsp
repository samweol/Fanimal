			...
			<div style="font-size: 30px; display:flex; justify-content: center; padding-bottom: 30px;">커뮤니티</div>
				...
				<table class="table table-hover horizontal" >
					...
					<tr>
						<td>${dto.commuseq}</td>
						<td>
							<a href="/fanimal/community/freeviewcp.do?seq=${dto.commuseq}&isSearch=${map.isSearch}&column=${map.column}&word=${map.word}">${dto.title}</a>
				...
				<div>
					<form method="GET" action="/fanimal/community/freelistcp.do"  style="display:flex; justify-content: center; padding-bottom: 30px;">
					<table class="search">
						<tr>
							<td>
							...
							<td>
								...
								<button class="btn btn-secondary" type="button"
									onclick="location.href='/fanimal/community/freelistcp.do';">
									돌아가기
								</button>
								</c:if>
							</td>
